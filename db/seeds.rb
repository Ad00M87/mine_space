...
20.times do
  ...
  30.times do
    ...
    my_post = Post.create(title: title, body: body, image: image, user_id: my_user.id)
    5.times do
      body = Faker::ChuckNorris.fact
      Comment.create(body: body, post_id: my_post.id)
    end
  end
end

puts "Users, Posts, and Comments seeded"
